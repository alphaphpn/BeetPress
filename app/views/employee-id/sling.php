	...
	<style>
		...
		#qrcode img { width: 100%; max-width: 58px; margin: auto; padding: 8px; }
	</style>
		...
		<tbody style="height: 495px;">
			...
			<tr style="height: 28px;">
				<td colspan="3" style="vertical-align: bottom;">
					<p style="font-size: xx-small; font-weight: 400; margin-top: auto; margin-bottom: 0; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; max-width: 290px; margin-right: 12px; margin-left: auto; line-height: 1; text-align: right; color: #ffffff;"><?php echo trim($createdatcc); ?></p>
				</td>
			</tr>
			...
			<tr>
				<td colspan="3">
					<div style="width: 100%; width: -webkit-fill-available; max-width: 110px; height: 140px; background-image: url('<?php echo trim($domainhome)."/public/employeeID/".trim($empidcodecc).".jpg" ?>'); background-repeat: no-repeat; background-position: center; background-size: cover; margin-top: auto; margin-left: auto; margin-right: auto; margin-bottom: -6px; box-shadow: rgba(0, 0, 0, 0.16) 0px 2px 5px 0px, rgba(0, 0, 0, 0.12) 0px 2px 10px 0px; border: 2px solid #ffffff; border-radius: 5px;"></div>
				</td>
			</tr>

			<tr>
				<td colspan="3" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%;">
					<div style="margin-top: 0; margin-bottom: -16px; padding-top: 0; padding-bottom: 0; width: 100%;"><svg id="barcode"></svg></div>
					<p style="font-weight: bolder; font-size: xxx-large; margin-top: 0; margin-bottom: 0px; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; max-width: 290px; margin-right: auto; margin-left: auto; line-height: 1;"><?php echo trim(mb_strtoupper($nicknamecc)); ?></p>
			...
			<tr>
				<td style="width: 33.3333%; vertical-align: bottom;">
					<p style="font-size: xx-small; font-weight: 400; margin-top: auto; margin-bottom: 8px; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; max-width: 290px; margin-right: auto; margin-left: 12px; line-height: 1; text-align: left; color: #ffffff;">Phone: <br><?php echo trim($mphonecc); ?></p>
				</td>
	...
	<script>
		new QRCode(document.getElementById("qrcode"), "<?php echo trim($empidcodecc); ?>");
	</script>

	<?php // for QRCode Data : { "name":"John", "age":30, "city":"New York" } ?>