<?php $photourl2 = trim($pixloc); ?>

	<style>
		#barcode { border-radius: 50px; }
		#qrcode2 img { width: 100%; max-width: 58px; margin: auto; padding: 8px; }
	</style>
		...
		<tbody style="height: 495px;">
			...
			<tr style="height: 28px;">
				<td colspan="3" style="vertical-align: bottom;">
					<p style="font-size: xx-small; font-weight: 400; margin-top: auto; margin-bottom: 0; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; max-width: 290px; margin-right: 12px; margin-left: auto; line-height: 1; text-align: right; color: #ffffff;"><?php echo trim(remLeaveNmbrOnly($createdatcc1)); ?></p>
				</td>
			</tr>
			...
			<tr>
				<td style="width: 33.3333%; vertical-align: bottom;">
					<p style="font-size: 8px; font-weight: 400; margin-top: auto; margin-bottom: 8px; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; margin-right: auto; margin-left: 12px; line-height: 1; text-align: left; color: #ffffff;">Phone: <br><?php echo trim($mphonecc1); ?></p>
	...
	<script>
		new QRCode(document.getElementById("qrcode2"), "<?php echo trim($empidcodecc1); ?>");
	</script>