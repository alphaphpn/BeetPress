		...
		<tbody style="height: 495px;">
			...
			<tr>
				<td style="width: 33.3333%; vertical-align: bottom;">
					<p style="font-size: xx-small; font-weight: 400; margin-top: auto; margin-bottom: 8px; padding-top: 0; padding-bottom: 0; word-wrap: break-word; width: 100%; margin-right: auto; margin-left: 12px; line-height: 1; text-align: left; color: #ffffff;">Phone: <br><?php echo trim($mphonecc1); ?></p>
				</td>
	...
	<?php 
		$slgqrcodz2 = genEmpQrCodeZ($empidcodecc1,$nicknamecc1,$empnameforidcc1,$birthdaycc1,$designationforidcc1,$officenameforidcc1,$createdatcc1); 
	?>

	<textarea id="slgqrcodz2" type="text" name="slgqrcodz2" class="d-none" readonly>
		<?php echo trim($domainhome)."/employee/".$empidcodecc1; ?>

		<?php echo trim($slgqrcodz2); ?>
	</textarea>

	<script>
		const slgqrcodz2 = document.getElementById("slgqrcodz2").innerHTML;
		new QRCode(document.getElementById("qrcode2"), slgqrcodz2);
	</script>