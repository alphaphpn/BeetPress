<?php
	...
	// Clients select the attendance fields; only the server supplies their times.
	$serverAttendanceTime = (new DateTimeImmutable('now', new DateTimeZone('Asia/Manila')))->format('g:i');
	$amtimein    = isset($_GET['amtimein']) ? $serverAttendanceTime : null;
	$amtimeout   = isset($_GET['amtimeout']) ? $serverAttendanceTime : null;
	$pmtimein    = isset($_GET['pmtimein']) ? $serverAttendanceTime : null;
	$pmtimeout   = isset($_GET['pmtimeout']) ? $serverAttendanceTime : null;
