<?php
	...
	$the_htitle = "Employee Pocket ID";
	$the_refresh = null;
	$the_expires = null;
	include_once "app/theme/{$theme}/template-part/header-plain.php";
	include_once "app/views/employee-id-pocket-group/index.php";
	include_once "app/theme/{$theme}/template-part/footer-plain.php";

	/** For Web Refresh
	 * null seconds for NO REFRESH
	 * 60 seconds for 1 minute
	 * 180 seconds for 1 minute
